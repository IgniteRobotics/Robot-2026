...
public class DriveState {
  ...
  private DriveState() {
    ...
    concurrentQueueMap.put(
        CameraConstants.photonCameraName1, new ConcurrentLinkedQueue<VisionMeasurement>());
    concurrentQueueMap.put(
        CameraConstants.photonCameraName2, new ConcurrentLinkedQueue<VisionMeasurement>());
  }
