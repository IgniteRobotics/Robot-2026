...
public class IndexerSubsystem extends SubsystemBase{
    ...
    public void periodic() {
        indexerMotor.setControl(indexerControl.withVelocity(indexerVelocityTarget.in(RotationsPerSecond)));
    }

    public Command indexCommand() {
        return runOnce(() -> indexerVelocityTarget = RotationsPerSecond.of(IndexerPreferences.indexSpeed.getValue()))
